...
func isReadOnly(jobType string) bool {
	switch jobType {
	case "MOD_LIST", "MOD_QUARANTINE_LIST", "MOD_PENDING_LIST", "MOD_CONFIG_READ", "PROFILE_LIST", "PROFILE_READ", "PLAYER_LIST_SYNC", "PLAYER_ADMIN_LIST", "SAVE_LIST", "REGION_HEALER_STATUS", "ITEM_CATALOG", "POI_CATALOG", "POI_PREVIEW":
		return true
	default:
		return false
	}
