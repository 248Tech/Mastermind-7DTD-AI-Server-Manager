...
@Module({
  imports: [AuthModule, PrismaCoreModule, AllocsModule, JobsModule, JwtModule.register({ secret: process.env.PLAYER_JWT_SECRET || process.env.JWT_SECRET || 'change-me-user-secret' })],
