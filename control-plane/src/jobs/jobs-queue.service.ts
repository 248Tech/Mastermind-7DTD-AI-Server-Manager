...
export class JobsQueueService implements OnModuleDestroy {
  ...
  private isReadOnly(type: string): boolean {
    ...
    return ['MOD_LIST','MOD_QUARANTINE_LIST','MOD_PENDING_LIST','MOD_CONFIG_READ','PROFILE_LIST','PROFILE_READ','PLAYER_LIST_SYNC','PLAYER_ADMIN_LIST','SAVE_LIST','ITEM_CATALOG'].includes(type);
  }
}
