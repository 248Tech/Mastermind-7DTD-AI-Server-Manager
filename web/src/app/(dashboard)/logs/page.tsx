...
import { api, LogKeywordMatch, LogKeywordRule, ServerInstance, ServerLog } from '../../../lib/api';
...
export default function LogsPage() {
  ...
  return <div>
    ...
    <pre style={{height:'calc(100vh - 430px)',minHeight:280,overflow:'auto',whiteSpace:'pre-wrap',wordBreak:'break-word',background:'#08080c',color:'#cbd5e1',border:'1px solid #1e1e2a',borderRadius:8,padding:'1rem',fontSize:'0.78rem',lineHeight:1.45,margin:0}}>{logs.map(l=><span key={l.id}>{l.content}</span>)}<div ref={bottom}/></pre>
  </div>;
}
