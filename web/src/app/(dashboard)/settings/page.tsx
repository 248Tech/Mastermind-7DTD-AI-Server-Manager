...
JOB_TIMEOUT_SECONDS=600`;
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([u, o]) => { setUser(u); setOrg(o); setWebhookUrl(o?.discordWebhookUrl||''); setAvoidBloodMoonRestart(Boolean(o?.avoidBloodMoonRestart));setOpenaiConfigured(Boolean(o?.openaiConfigured));setOpenaiModel(o?.openaiModel||'gpt-5.3-codex');setModAiProvider(o?.modAiProvider||'codex');setKimiConfigured(Boolean(o?.kimiConfigured));setKimiModel(o?.kimiModel||'kimi-for-coding'); setLoading(false); })
